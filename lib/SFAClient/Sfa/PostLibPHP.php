...
class PostLibPHP{
	...
	function readPropFile()
	{
		...
		if(!file_exists("/home/cybrain1/public_html/myshop/SFAClient/sfa.properties"))
		{
		error_log("Property file is not exist.", 0);
		}
		
		$fp = fopen ("/home/cybrain1/public_html/myshop/SFAClient/sfa.properties","r");
